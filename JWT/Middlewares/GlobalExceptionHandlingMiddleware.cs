...
public class GlobalExceptionHandlingMiddleware
{
    ...
    private static async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        {
            CourseNotFoundException => (HttpStatusCode.NotFound, "Course Not Found", exception.Message),
            EnrollmentNotFoundException => (HttpStatusCode.NotFound, "Enrollment Not Found", exception.Message),
            LessonNotFoundException => (HttpStatusCode.NotFound, "Lesson Not Found", exception.Message),
            ReviewNotFoundException => (HttpStatusCode.NotFound, "Review Not Found", exception.Message),
